...
export default function Navbar() {
  return (
    <nav className="sticky top-0 z-10 border-b border-gray-200 dark:border-gray-700 bg-background py-4 font-mono">
      <div className="container mx-auto flex items-center justify-between px-6">
        ...
        <ul className="flex text-lg">
          ...
          <li><Link href="/#about" className="text-black dark:text-white hover:text-white dark:hover:text-black hover:bg-black dark:hover:bg-white p-4 rounded-xl">About</Link></li>
          <li><Link href="/#bio" className="text-black dark:text-white hover:text-white dark:hover:text-black hover:bg-black dark:hover:bg-white p-4 rounded-xl">Bio</Link></li>
